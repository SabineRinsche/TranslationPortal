...
// MemoQ supported languages list
export const memoQLanguages = [
  ...
  { value: 'Amharic', label: 'Amharic', code: 'amh' },
  ...
  { value: 'Burmese', label: 'Burmese', code: 'mya' },
  ...
  { value: 'Khmer', label: 'Khmer', code: 'khm' },
