      ...
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <Link href="/">
          <div className="flex items-center space-x-2 cursor-pointer">
            ...
            <h1 className="text-xl font-semibold text-slate-800">TranslateNow</h1>
          </div>
        </Link>
        <div className="flex items-center space-x-4">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <button className="text-slate-600 hover:text-primary relative">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex items-center space-x-2 text-sm focus:outline-none">
                  ...
                  <span className="font-medium text-slate-700 hidden md:inline-block">John Doe</span>
                </button>
              </DropdownMenuTrigger>
